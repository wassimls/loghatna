    ...
    basics: {
        ...
        travel: {
            words: [
                ...
                { word: "Map", translation: "خريطة", pronunciation: "ماب", emoji: "🗺️" },
                { word: "Suitcase", translation: "حقيبة سفر", pronunciation: "سوتكيس", emoji: "🧳" },
                { word: "Luggage", translation: "أمتعة", pronunciation: "لغيج", emoji: "🧳" },
                { word: "Tourist", translation: "سائح", pronunciation: "توريست", emoji: "📸" },
                { word: "Destination", translation: "وجهة", pronunciation: "ديستينيشن", emoji: "📍" },
            ],
            readingExercises: [
                readingExercise("I need a passport and a ticket for the airplane.", "ترجم الكلمات 'passport', 'ticket', و 'airplane'.", "أحتاج جواز سفر وتذكرة للطائرة.", ["الفندق قريب من محطة القطار.", "هل هذه سيارتك الجديدة؟", "لا تنس الخريطة والحقيبة."]),
                readingExercise("Our destination is a beautiful island for the holiday.", "ابحث عن مكان ونوع الرحلة.", "وجهتنا هي جزيرة جميلة لقضاء العطلة.", ["السائح يلتقط الكثير من الصور.", "أمتعتي ثقيلة جدا.", "سأستقل سيارة أجرة إلى المطار."])
            ],
            listeningExercises: [
    ...
    games: [
        {
            type: 'match',
            title: 'Food Match',
            description: 'Match the food with its name in Arabic.',
            items: [
                { id: 'eng_match_1', word: 'Apple', translation: 'تفاحة' },
                { id: 'eng_match_2', word: 'Bread', translation: 'خبز' },
                { id: 'eng_match_3', word: 'Cheese', translation: 'جبن' },
                { id: 'eng_match_4', word: 'Water', translation: 'ماء' },
            ]
        },
        {
            type: 'missing_word',
            ...
            sentence: 'I read a {blank} every week.',
            correctWord: 'book',
            options: ['book', 'house', 'water', 'car']
        },
        {
            type: 'sentence_scramble',
            title: 'Sentence Scramble',
            description: 'Put the words in order to form a sentence.',
        ...
        },
        {
            type: 'match',
            title: 'Travel Match',
            description: 'Match the travel-related words.',
            items: [
                { id: 'eng_match_5', word: 'Ticket', translation: 'تذكرة' },
                { id: 'eng_match_6', word: 'Passport', translation: 'جواز سفر' },
                { id: 'eng_match_7', word: 'Hotel', translation: 'فندق' },
                { id: 'eng_match_8', word: 'Airport', translation: 'مطار' },
            ]
        }
    ]
};
