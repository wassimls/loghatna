 ...
 */
export const getGames = async (apiKey: string, language: string): Promise<GamesCollection | null> => {
    try {
        const generatedGames = await openrouterService.generateGamesForLanguage(apiKey, language);
